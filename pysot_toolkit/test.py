...
def main():
    # load config
    #'/data/zmh/LaSOT/LaSOTBenchmark/'
    #'/data/zmh/GOT-10k/test/'
    #'/data/zmh/trackingnet/test'
    #'/data/zmh/testing_dataset/OTB100'
    #'/data/zmh/testing_dataset/VOT2018/'
    #'/data/zmh/uav/UAV123/data_seq/UAV123/'
    #/data/zmh/trackingnet/TEST/frames/
    dataset_root = '/data/zmh/trackingnet/TEST/frames/' #Absolute path of the dataset
    net_path = '/home/zmh/Trxy/snapshotorixy/checkpoints/ltr/transt/transt/TransT_ep0600.pth.tar' #Absolute path of the model
