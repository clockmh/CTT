import torch
from ltr.dataset import Lasot, MSCOCOSeq, Got10k, TrackingNet, ImagenetVID
...
def run(settings):
    ...
    dataset_train = sampler.TransTSampler([got10k_train], [1],#lasot_train, trackingnet_train, got10k_train, 
    ...
    trainer.train(600, load_latest=True, fail_safe=True)
